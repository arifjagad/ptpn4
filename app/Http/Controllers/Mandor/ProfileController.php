...
class ProfileController extends Controller
{
    ...
    {
        //
        return view ('mandor.profile.index');
    }
    ...
    public function updateMandor(Request $request){
        ...
        $user = User::find(auth()->id());
        $mandor = $user->mandor;
        $mandor->nik = $request->nik;
        $mandor->niksap = $request->niksap;
        $mandor->nomor_telp = $request->nomor_telp;
        $mandor->jenis_kelamin = $request->jenis_kelamin;
        $mandor->save();
