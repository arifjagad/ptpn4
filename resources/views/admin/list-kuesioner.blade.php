@extends('admin.layouts.vertical', ['page_title' => 'Manajemen Kuesioner'])
            ...
            <div class="col-12">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        {{-- List data table --}}
                        <table id="datatable-admin-kuesioner" class="table table-striped w-100 nowrap">
                            <thead>
                                <tr>
                                    <th>Nama Karyawan</th>
                                    <th>Agenda</th>
...
@section('script')
    @vite([
        ...
        'resources/js/custom/admin-kuesioner.js',
    ])
